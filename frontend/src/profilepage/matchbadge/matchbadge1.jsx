...
const styles = {
  Icon: {
    color: '#030303',
    fill: '#030303',
    fontSize: '32px', // Adjusted
    // top: '239px', // Consider removing or adjusting if badge is used in normal flow
    // left: '223px',// Consider removing or adjusting if badge is used in normal flow
    width: '32px',  // Adjusted
...
const IconComponent = () => (
  <svg className="badgeIcon" viewBox="0 0 512 512">
